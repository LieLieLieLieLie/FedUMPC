...
- `MuJoCo/` contains the MuJoCo 3.1.1 cross-simulator deployment and viewer
  reproduction workflow.

See the README in each directory for installation, scope, and reproduction
instructions. Generated caches and local build executables are intentionally
