"""Auditable MuJoCo tuning sweep for FedRMPC deployment parameters.

The sweep keeps the scene, BNN, candidate set, horizon, and physical plant
fixed.  It changes only the documented FedRMPC cost/margin parameters and
...
def main() -> None:
    ...
    destination = OUTPUT / "fedrmpc_tuning_seed123.json"
